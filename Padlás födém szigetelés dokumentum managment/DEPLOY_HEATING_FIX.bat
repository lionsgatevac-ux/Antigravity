...
set VERSION=v58_heating_fix

echo ========================================================
echo  DEPLOYMENT SCRIPT - %VERSION% (Cloud Build Strategy)
echo ========================================================

echo 1. Building Container with Cloud Build (No local Docker needed)...
