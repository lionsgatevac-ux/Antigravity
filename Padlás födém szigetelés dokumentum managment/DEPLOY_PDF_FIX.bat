...
set VERSION=v57_pdf_fix

echo "🚀 STARTING PDF FIX DEPLOYMENT (Installing LibreOffice)..."

echo "🔨 Building Container..."
call gcloud builds submit --tag %IMAGE_NAME%:%VERSION% --timeout=20m .
